...
class AppointRecordModel extends BaseModel {
    ...
    public static $APPOINT_TYPE = [
        ...
        1234 => [
            ...
            'date' => '周二除外 ',
            'statement' => '说明',
            'description' => '<p>1、签证预约时段：</p><p>&nbsp;&nbsp;&nbsp;&nbsp;上午: 08:30-09:30, 09:30-10:30, 10:30-11:30</p><p>&nbsp;&nbsp;&nbsp;&nbsp;下午: 13:30-14:30, 14:30-15:30, 15:30-16:30</p><p>2、每个时间段最多可预约5人</p><p>3、可预约当天项目</p>',
            // 每个时间段最多可预约5人
            'appoint' => [
                'time_list' => [
                    '08:30-09:30',
        ...
        1235 => [
            ...
            'date' => '提前3天预约（周二除外）',
            'statement' => '退费预约',
            'description' => '<p>退费预约时段</p><p>提前3天预约，如6月1号只能预约到6月4日的时间</p><p>时间段为09:00-11:00，14:00-16:00，每个时间段有10个预约名额</p>',
            'appoint' => [
                'time_list' => [
                    '09:00-11:00',
                    '14:00-16:00',
        ...
        1236 => [
            ...
            'date' => '每周五下午',
            'statement' => '说明',
            'description' => '<p>退费预约时段</p><p>每周五下午：13:30-14:30，14:30-15:30，15:30-16:30， 每个时段可预约5人</p>',
            'appoint' => [
                'time_list' => [
                    '13:30-14:30',
                    '14:30-15:30',
        ...
        1237 => [
            ...
            'date' => '只有6月份和12月份开放',
            'statement' => '说明',
            'description' => '<p>宿舍调换预约时段</p><p>1、 只在6月份和12月份开放，预约方法与签证业务一样，提前2天预约</p><p>如6月1号只能预约到6月3日的时间。时间段为09:00-11:00，14:00-16:00，每个时间段有10个预约名额</p>',
            'appoint' => [
                'time_list' => [
                    '09:00-11:00',
                    '14:00-16:00',
