...
class AppointLogic extends UserBaseLogic {
    ...
    public function details() {
        ...
        $return['data'][0]['form_data']['model'][1]['subModelName'][0] = $appoint_info[$item]['date'] ? $appoint_info[$item]['date'] : '';
    ...
    public function add_document() {
        ...
        // 转学证明仅语言生可以申请
        return ['status' => 1, 'data' => $transfer_letter];
        $userService = new UserService();
