...
class WXLoginHelper {
    ...
    protected $config = [
        ...
        'appid' => 'wx0f0fe4d0f2fffd6c', // APPId
        'secret' => '5a6190163c43ca87e911440049d93d79', // 秘钥
    ...
    public function __construct ($code = '', $rawData = '', $signature = '', $encryptedData = '', $iv = '', $from = 'student')
    {
        ...
        $this->iv = $iv;
        if ($from == 'teacher') {
            $this->config['appid'] = 'wx0f0fe4d0f2fffd6c';
            $this->config['secret'] = '5a6190163c43ca87e911440049d93d79';
        }
    }
    ...
    public function getUserTelV2($session_key) {
