...
class PHPExcel_Calculation {
     ...
     *
     */
    private static $validLocaleLanguages = array('en'        //    English        (default language)
    );
    /**
    ...
    private static $operatorAssociativity = array('^' => 0,                                                            //    Exponentiation
    ...
    private static $operatorPrecedence = array(':' => 8,                                                                //    Range
        '|' => 7,                                                                //    Intersect
        '~' => 6,                                                                //    Negation
        '%' => 5,                                                                //    Percentage
        '^' => 4,                                                                //    Exponentiation
