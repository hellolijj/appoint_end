...
class PHPExcel_Worksheet implements PHPExcel_IComparable {
            ...
            foreach ($this->getCellCollection(FALSE) as $cellID) {
                ...
                if ($cell !== NULL && isset($autoSizes[$this->cellCollection->getCurrentColumn()])) {
                    ...
                    if (!isset($isMergeCell[$this->cellCollection->getCurrentAddress()])) {
                        ...
                        $autoSizes[$this->cellCollection->getCurrentColumn()] = max((float)$autoSizes[$this->cellCollection->getCurrentColumn()], (float)PHPExcel_Shared_Font::calculateColumnWidth($this->getParent()->getCellXfByIndex($cell->getXfIndex())->getFont(), $cellValue, $this->getParent()->getCellXfByIndex($cell->getXfIndex())->getAlignment()->getTextRotation(), $this->getDefaultStyle()->getFont()));
                    }
                }
            }
    ...
    {
        $this->parent->getDefaultStyle()->applyFromArray(array('font' => array('name' => $pValue->getFont()->getName(), 'size' => $pValue->getFont()->getSize(),),));
        return $this;
    }
