...
class PHPExcel_Chart {
    ...
    {
        return array('cell' => $this->topLeftCellRef, 'xOffset' => $this->topLeftXOffset, 'yOffset' => $this->topLeftYOffset);
    }
    ...
    {
        return array('X' => $this->topLeftXOffset, 'Y' => $this->topLeftYOffset);
    }
    ...
    {
        return array('cell' => $this->bottomRightCellRef, 'xOffset' => $this->bottomRightXOffset, 'yOffset' => $this->bottomRightYOffset);
    }
    ...
    {
        return array('X' => $this->bottomRightXOffset, 'Y' => $this->bottomRightYOffset);
    }
